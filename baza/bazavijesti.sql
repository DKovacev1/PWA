...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2000370637ltr&server=1">
...
<body>
    <div id="pma_navigation" data-config-navigation-width="279">
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=bazavijesti&table=korisnici">`bazavijesti`.`korisnici`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=users&table=predmeti">`users`.`predmeti`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=users&table=korisnik">`users`.`korisnik`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=users&table=users">`users`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=bazavijesti&table=novosti">`bazavijesti`.`novosti`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=vjezba_3&table=korisnik">`vjezba_3`.`korisnik`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=predmeti&table=predmeti">`predmeti`.`predmeti`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="694c7943274b61526869472f385f6a50">
...
</span><small>Set to 0 to collapse navigation panel.</small></th><td><input type="number" name="NavigationWidth" id="NavigationWidth" class="custom" value="279"><a class="restore-default hide" href="#NavigationWidth" title="Restore default value"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_reload"></a></td></tr></table>
</fieldset>
